...
export default function Footer() {
  ...
  return (
    <footer
      className="bg-[#0A0A0F] border-t border-[rgba(59,130,246,0.1)] pt-16 pb-8"
      role="contentinfo"
    >
              ...
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  <button
                    ...
                    className="text-[#A0A0B0] hover:text-[#3B82F6] text-sm transition-colors duration-200 cursor-pointer"
                  >
                    {link.label}
                  </button>
                </li>
